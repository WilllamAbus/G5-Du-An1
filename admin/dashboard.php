                                        ...
                                        <ul class="nav nav-pills ml-auto">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#revenue-chart"
                                                   data-toggle="tab">Vùng</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#sales-chart" data-toggle="tab">Donout</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div><!-- /.card-header -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="todo-list" data-widget="todo-list">
                                        <li>
                                            ...
                                            <!-- todo text -->
                                            <span class="text">Thiết kế một theme</span>
                                            <!-- Emphasis label -->
                                        ...
                                        <li>
                                            ...
                                            <span class="text">Làm một giao diện responsive</span>
                                        ...
                                        <li>
                                            ...
                                            <span class="text">Làm chức năng cho giao diện</span>
                                        ...
                                        <li>
                                            ...
                                            <span class="text">Kiểm tra cuộc trò chuyện và thông báo</span>
                                ...
                                <div class="card-footer clearfix">
                                    <button type="button" class="btn btn-primary float-right"><i
                                                class="fas fa-plus"></i> Thêm nhiêm vụ
                                    </button>
                                </div>
                            </div>
                            <!-- /.card -->
