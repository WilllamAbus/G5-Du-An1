                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach (  $dshd  as $sanpham) {
                                        ...
                                        $chitiet = "index.php?page=chitietdonhang&ma_hd=".$ma_hd;
                                        $xoahd = "index.php?page=xoahd&ma_hd=".$ma_hd;
                                        echo '<tr>       
                                                            <td>' . $ma_hd . '</td>
                                                            <td>' . $ten_nd . '</td>
                                                            <td>' . $dia_chi . '</td>
                                                            ...
                                                            <a href="'.$xoahd.'"><input class="btn btn-primary" type="button" value="Xóa"></a> 
                            ...
                            <nav aria-label="Page navigation example d-block">
                                ...
                                for ($index = 1; $index <= $totalPages; $index++) {
                                    ...
                                    echo '  <li class="page-item ' . $active . '">
                                              <a class="page-link" href="index.php?page=donhang&page_num=' . $index . '">' . $index . '</a>
                                              </li>';
                                }
