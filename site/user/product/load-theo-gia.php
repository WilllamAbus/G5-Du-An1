        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="bg-light p-4 mb-30">
                <form action="index.php?page=theogia" method="post">
                    ...
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" name="loc" class="custom-control-input" id="price-1">
                    ...
                    <br>
                    <button type="submit" name="loc" class="btn btn-primary" style="border:none;">Lọc</button>
                </form>
            </div>
            <!-- Price End -->
            ...
            <div class="row pb-3">
                ...
                foreach ($hh as $sp) {
                    ...
                    <!-- <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="./user/style/img/product-6.jpg" alt="">
                    ...
                    <!-- <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="./user/style/img/product-7.jpg" alt="">
                    ...
                    <!-- <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="./user/style/img/product-8.jpg" alt="">
