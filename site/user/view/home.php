    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            <div class="product-item bg-light mb-4">
                <a href="index.php?page=sanpham">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-80  picture mt-5 ml-xl-2"
                             src="../controller/hinh/The100bestnonfiction.jpg"
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            <div class="product-item bg-light mb-4">
                <a href="index.php?page=sanpham">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-80  picture mt-5 ml-lg-5"
                             src="../controller/hinh/TheIntelligentInvestor.jpg"
    ...
    <div class="row px-xl-5">
        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            <div class="product-item bg-light mb-4">
                <a href="index.php?page=sanpham">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-80  picture mt-5 ml-lg-5" src="../controller/hinh/TheOBS.jpg"
                             alt="TheOBS.jpg">
                        <!-- <div class="">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            <div class="product-item bg-light mb-4">
                <a href="index.php?page=sanpham">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-80  picture mt-5 ml-lg-5" src="../controller/hinh/TheEndOFSelfHelp.jpg"
                             alt="TheEndOFSelfHelp">
                        <!-- <div class="">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            <div class="product-item bg-light mb-4">
                <a href="index.php?page=sanpham">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-80  picture mt-5 ml-lg-5" src="../controller/hinh/MakingTheComplex.jpg"
                             alt="makingTheComplex.jpg">
                        <!-- <div class="">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            <div class="product-item bg-light mb-4">
                <a href="index.php?page=sanpham">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-80  picture mt-5 ml-lg-5" src="../controller/hinh/bbb.jpg"
                             alt="bbb.jpg">
                        <!-- <div class="">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
